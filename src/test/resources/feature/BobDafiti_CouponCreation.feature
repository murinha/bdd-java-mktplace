...
Scenario: Coupon Creation
	...
	And i mouseover on "Promotion" menu, click on "Vouchers" option in "Bob Dafiti"
	...
	And i wait for "Template Management" page to load
	And i fill field "Name" with value "test" in "Template Management"
	And i fill field "Description" with value "test" in "Template Management"
